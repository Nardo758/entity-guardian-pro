  ...
  const UserMenu = () => {
    ...
    return (
      <div className="relative" ref={dropdownRef}>
        <Button
          variant="ghost"
          className="flex items-center space-x-2 hover:bg-muted/50 px-2"
        ...
        >
          ...
          <div className="flex flex-col items-start text-left">
            <span className="text-sm font-medium max-w-32 text-black truncate">
              {getDisplayName()}
            </span>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              {loading && !authTimeout ? (
                ...
                <>
                  <Button variant="ghost" asChild className="text-foreground hover:text-foreground hover:bg-muted">
