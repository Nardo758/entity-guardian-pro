...
const Settings = () => {
  ...
  const userType = (authProfile as any)?.user_type;
  const dashboardPath = isAdmin
    ? "/admin-dashboard"
    : userType === "registered_agent"
      ? "/agent-dashboard"
      : "/dashboard";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="text-center space-y-1">
                      <p className="font-semibold">
                        {`${settingsProfile.first_name} ${settingsProfile.last_name}`.trim()}
                      </p>
              ...
              <div className="lg:col-span-3">
                <Tabs defaultValue="profile" className="w-full">
                  <TabsList
                    className={`grid w-full ${hasAdminAccess ? "grid-cols-6" : "grid-cols-4"}`}
                  >
                    <TabsTrigger
                      value="profile"
                        ...
                        {subLoading ? (
                          ...
                          <>
                            <div className="p-4 bg-success/10 border border-success/20 rounded-lg">
                              <div className="flex items-center justify-between">
                                <div>
                                  <h3 className="font-semibold text-success capitalize">
                            ...
                            <div className="space-y-4">
                              <div className="flex flex-col gap-3">
                                ...
                                <p className="text-xs text-muted-foreground text-center">
                                  Update payment method, view invoices, and
                                  manage your billing through Stripe
                                </p>
                              </div>
                            </div>
                          </>
