...
interface EntityEditModalProps {
  ...
  open: boolean;
  onClose: () => void;
  onSave: (entity: Partial<Omit<Entity, 'id' | 'user_id' | 'created_at' | 'updated_at'>>) => void;
}
  ...
  useEffect(() => {
    if (entity) {
      setFormData({
        ...
        registered_agent_email: entity.registered_agent_email || '',
        registered_agent_phone: entity.registered_agent_phone || '',
        registered_agent_fee: entity.registered_agent_fee || 0,
        registered_agent_fee_due_date: entity.registered_agent_fee_due_date || '',
        independent_director_name: entity.independent_director_name || '',
        independent_director_email: entity.independent_director_email || '',
        independent_director_phone: entity.independent_director_phone || '',
        independent_director_fee: entity.independent_director_fee || 0,
        independent_director_fee_due_date: entity.independent_director_fee_due_date || ''
      });
    }
  }, [entity]);
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="rounded-lg border bg-muted/30 p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="agentFeeDate">Agent Fee Due Date</Label>
                    <Input
                      id="agentFeeDate"
                      type="date"
                      value={formData.registered_agent_fee_due_date}
                      onChange={(e) => setFormData({ ...formData, registered_agent_fee_due_date: e.target.value })}
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="rounded-lg border bg-info-muted/30 p-4">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="directorFeeDate">Director Fee Due Date</Label>
                        <Input
                          id="directorFeeDate"
                          type="date"
                          value={formData.independent_director_fee_due_date}
                          onChange={(e) => setFormData({ ...formData, independent_director_fee_due_date: e.target.value })}
                        />
                      </div>
                    </div>
                  </div>
