# Test Stripe Webhook with CLI (Simple Version)
...
if (-not (Test-Path $STRIPE_CLI)) {
    Write-Host "ERROR: Stripe CLI not found at: $STRIPE_CLI" -ForegroundColor Red
    Write-Host "Please check the path and try again." -ForegroundColor Yellow
    exit 1
}

Write-Host "SUCCESS: Stripe CLI found" -ForegroundColor Green
Write-Host ""
...
switch ($choice) {
    "1" {
        ...
        Write-Host ""
        Write-Host "SUCCESS: Event sent! Check your database:" -ForegroundColor Green
    ...
    "2" {
        ...
        Write-Host ""
        Write-Host "SUCCESS: Lifecycle test complete! Check:" -ForegroundColor Green
    ...
    "3" {
        ...
        Write-Host ""
        Write-Host "SUCCESS: Event sent! Check:" -ForegroundColor Green
    ...
    "4" {
        ...
        Write-Host ""
        Write-Host "SUCCESS: Event sent! Check if subscription_status changed to 'past_due':" -ForegroundColor Green
    ...
    "5" {
        ...
        Write-Host ""
        Write-Host "SUCCESS: All events sent! Verify in database:" -ForegroundColor Green
    ...
    default {
        Write-Host ""
        Write-Host "ERROR: Invalid choice. Please run again and choose 1-7." -ForegroundColor Red
    }
}
